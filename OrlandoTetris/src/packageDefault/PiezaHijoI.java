...
public class PiezaHijoI extends PiezaPadre {
	...
	public PiezaHijoI(String color, int[][] fondo, int[] posicion, boolean fin, int siguientePieza) {
		super(color, fondo, posicion, fin);
		this.rotarPieza = siguientePieza;

		color = "#ff8000";

		// posición por defecto, la I solo contiene 2
	...
	public void posicion1(int[] posicion, int[][] fondo) {
		...
		// Se crea la estructura en forma de I
		fondo[0][2] = 1;
		fondo[1][2] = 1;
		fondo[2][2] = 1;
		fondo[3][2] = 1;
