...
public class PiezaHijoL extends PiezaPadre {
	...
	public PiezaHijoL(String color, int[][] fondo, int[] posicion, boolean fin, int siguientePieza) {
	...
	public void posicion1(int[] posicion, int[][] fondo) {
		...
		// Se crea la estructura en forma de L
		fondo[1][2] = 1;
		fondo[2][2] = 1;
		fondo[3][2] = 1;
		fondo[3][3] = 1;
	...
	public void posicion3(int[] posicion, int[][] fondo) {
		...
		// Se crea la estructura en forma de L
		// Habría que ajustar bien la rotación
		fondo[1][1] = 1;
		fondo[1][2] = 1;
		fondo[2][2] = 1;
		fondo[3][2] = 1;
