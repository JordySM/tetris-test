...
public class PiezaHijoS extends PiezaPadre {
	...
	public PiezaHijoS(String color, int[][] fondo, int[] posicion, boolean fin, int siguientePieza) {
	...
	public void posicion1(int[] posicion, int[][] fondo) {
		...
		// Se crea la estructura en forma de S
		fondo[1][2] = 1;
		fondo[1][3] = 1;
		fondo[2][1] = 1;
		fondo[2][2] = 1;
