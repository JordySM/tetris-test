...
public class PiezaHijoT extends PiezaPadre {
	...
	public PiezaHijoT(String color, int[][] fondo, int[] posicion, boolean fin, int siguientePieza) {
	...
	public void posicion1(int[] posicion, int[][] fondo) {
		...
		// Se crea la estructura en forma de T
		fondo[1][1] = 1;
		fondo[1][2] = 1;
		fondo[1][3] = 1;
		fondo[2][2] = 1;
